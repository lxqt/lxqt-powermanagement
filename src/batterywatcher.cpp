    ...
    if (powerLowActionRequired)
    {
        ...
        if (milliSecondsToAction > 0)
        {
            ...
            case LXQt::Power::PowerSuspend:
                notification->setBody(tr("Suspending in %n second(s)", NULL, secondsToAction).arg(secondsToAction));
                break;
            case LXQt::Power::PowerHibernate:
                notification->setBody(tr("Hibernating in %n second(s)", NULL, secondsToAction).arg(secondsToAction));
                break;
            case LXQt::Power::PowerShutdown:
                notification->setBody(tr("Shutting down in %n second(s)", NULL, secondsToAction).arg(secondsToAction));
                break;
            }
